...
public:
    RegularSMS(char *_pretplatnik="",float _basePrice=0,char *_textMessage="",bool _roaming=false):SMS(_pretplatnik,_basePrice){
    ...
    double SMS_cena() const {
        float numMessages = (strlen(textMessage) + 159) / 160;  // Calculate the number of messages needed to accommodate the text
...
public:
    SpecialSMS( char *_pretplatnik="",float _basePrice=0,bool _humanitarni=false) : SMS(_pretplatnik,_basePrice){
