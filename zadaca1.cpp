...
protected:
    ...
    double basePrice;
public:
    Book(const char* _isbn="", const char* _title="", const char* _author="", double _basePrice=0.0) : basePrice(_basePrice) {
        strcpy(isbn, _isbn);
        strcpy(title, _title);
...
private:
    ...
    int sizeMB;
public:
    OnlineBook(const char* _isbn, const char* _title, const char* _author, double _basePrice, const char* _url, int _sizeMB)
...
private:
    ...
    bool inStock;
public:
    PrintBook(const char* _isbn, const char* _title, const char* _author, double _basePrice, double _weight, bool _inStock) :  Book(_isbn,_title,_author,_basePrice),weight(_weight),inStock(_inStock){
    }

    PrintBook(const PrintBook& other) : Book(other.isbn, other.title, other.author, other.basePrice), weight(other.weight), inStock(other.inStock) {
    }
