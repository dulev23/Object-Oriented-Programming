...
private:
    double carPrice;
public:
    Avtomobilist(char *_name= nullptr,int _age=0, int _numRaces=0, bool _veteran=false, double _carPrice=0.0) : Vozac(_name,_age,_numRaces,_veteran){
        carPrice=_carPrice;
    }
...
private:
    int motorPower;
public:
    Motociklist(char *_name= nullptr,int _age=0, int _numRaces=0, bool _veteran=false, int _motorPower=0) : Vozac(_name,_age,_numRaces,_veteran){
