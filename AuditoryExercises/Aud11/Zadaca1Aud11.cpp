...
protected:
    ...
    double limit;
public:
    Card(char *id = "111111111111111", double limit = 1000, double balance = 0.0) {
        strcpy(this->id, id);
...
public:
    MasterCard(char *id = "111111111111111", double limit = 1000, double balance = 0.0) : Card(id, limit, balance) {
...
public:
    MaestroCard(char *id = "111111111111111", double limit = 1000, double balance = 0.0) : Card(id, limit, balance) {
...
int main() {
    ...
    cards[3] = new MasterCard("111111111111114", 0, 10000);
