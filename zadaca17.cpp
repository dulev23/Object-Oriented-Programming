...
private:
    ...
    int numTitles;
public:
    Klub(const char *_name="", const int *_goals=nullptr, const char *_ime="", const int _numTitles=0) : FudbalskaEkipa(_name, _goals){
...
private:
    ...
    int appearances;
public:
    Reprezentacija(const char *_name="", const int *_goals=nullptr, const char *_country="", const int _appearances=0) : FudbalskaEkipa(_name, _goals), country(), appearances(_appearances){
